...
public class SessionManager {
  ...
  private static void logoutPlatformSession(PlatformSession platformSession) {
    try {
      Optional.of(platformSession.getPlatformSession_Session())
              .ifPresent(sessions -> sessions.forEach(SessionManager::logoutSession));
  ...
  private static void associateSessionToPlatformSession(
    ...
    final List<Session> sessonList =  platformSession.getPlatformSession_Session();
    sessonList.add(session);
    platformSession.setPlatformSession_Session(sessonList);
