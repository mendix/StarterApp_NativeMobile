...
public class UserProfileUtils {
    ...
    public static UserProfile getUserProfile(IContext context, Map<String, Object> userInfoJSONObject) throws ParseException {
        ...
        if (mxProfileClaim != null) {
            final UserProfile userProfile = extractUserProfileFromMxProfileClaim(context, mxProfileClaim);
            userProfile.setLocale(JSONObjectUtils.getString(userInfoJSONObject, "locale"));
            return userProfile;
        } else {
